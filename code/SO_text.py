...
for train_index,test_index in kf.split(total_sequence,total_labels_stance_enc):
    ...
    model=Model([input1],[stance_shared_output,senti_shared_output])
    ...
    model.fit([train_sequence],[train_stance,train_senti], shuffle=True,validation_split=0.2,epochs=20,verbose=2)
